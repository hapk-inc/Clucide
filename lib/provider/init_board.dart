...
class CreateBoard {
  final UnmodifiableMapView mPlayer;

  CreateBoard(this.mPlayer) {
    print("Create Board" + mPlayer.toString());
  }
  ...
  final Map<String, ClueCard> cardMap = Map.fromIterables(
    List.generate(21, (_) => mockString(13)),
    <ClueCard>{
